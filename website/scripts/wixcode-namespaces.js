...
(function webpackUniversalModuleDefinition(root, factory) {
	if(true)
		...
		exports["index"] = factory(require("wix"));
	else
		root["index"] = factory(root["wix"]);
...
(function webpackUniversalModuleDefinition(root, factory) {
  if (true) {module.exports = factory(__webpack_require__(0), __webpack_require__(3));} else if (typeof define === 'function' && define.amd) {define(['wix', '_'], factory);} else if (typeof exports === 'object') {exports['wixcode-users'] = factory(require('wix'), require('_'));} else {root['wixcode-users'] = factory(root.wix, root._);}
...
//# sourceMappingURL=wixcode-users.js.map
